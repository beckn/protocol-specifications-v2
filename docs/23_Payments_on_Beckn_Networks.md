...
| Role | Description |
|---|---|
| **Payer** (BAP) | The entity that collects or arranges payment from the consumer |
...
3. BAP renders payment interface to consumer; consumer pays BAP.
...
3. BAP renders the BPP's payment interface to the consumer.
4. Consumer pays BPP directly.
