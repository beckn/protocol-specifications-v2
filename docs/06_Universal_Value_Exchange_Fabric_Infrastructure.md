...
A BAP is a consumer-side platform. It represents the consumer's interface to the network. A BAP:
...
A BPP is a provider-side platform. It represents a provider's catalog, transaction engine, and fulfillment logic. A BPP:
